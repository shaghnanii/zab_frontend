...
export const FypTwoListComponent = () => {
    ...
    useEffect(() => {
        api.index('/supervisors-fyp-listing?level=2')
            .then(response => {
    ...
    return (
        <>
            ...
            <h2>Fyp-II Projects </h2>

            <br/>

            {projectLoader && projects && projects.Supervisor && projects.Supervisor.Groups.map(item =>
                <div className="member-entry">
                    ...
                    <div className="member-details"><h4>
                        ...
                        <div className="row info-list">
                            ...
                            <button className={'btn btn-info'} >View Student Details</button>
                        </div>
                        <div className="row info-list">
