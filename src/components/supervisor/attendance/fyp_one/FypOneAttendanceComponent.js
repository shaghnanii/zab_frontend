...
export const FypOneAttendanceComponent = () => {
    const [comments, setComments] = useState({});
    const [loader, setLoader] = useState(false);

    useEffect(() => {
        api.index('/supervisors-attendance-comments?level=1')
            .then(response => {
    ...
    return (<>
        ...
        <h2>Fyp Part-I <small>[ Meetings Attendance & Comments ]</small></h2>
                            ...
                            && comments.Supervisor.Groups.map(item =>
                                <tr>
                                    ...
                                    <td>
                                        <Link
                                            to={{
                                                pathname: "/supervisor/view-attendance-1",
                                        ...
                                        <Link
                                            to={{
                                                ...
                                                state: {
                                                    ...
                                                    back_url: 'attendance-and-meetings-part-1'
