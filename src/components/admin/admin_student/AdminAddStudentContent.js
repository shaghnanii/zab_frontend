...
export const AdminAddStudentContent = () => {
  ...
  const success_msg = () => {
    ...
    toastr.success('Successfully added new student.', 'Success Message', opts);
  }
  const failure_msg = () => {
    var opts = {
      "closeButton": true,
    ...
    toastr.error('Failed to added new student.', 'Failure Message', opts);
  }
  const handleSubmitClick = (e) => {
    ...
    api.admin_student_store(payload)
        .then(response => {
          success_msg()
        })
        .catch(err => {
            ...
            <div className="panel-body">
              ...
              >
                ...
                <div className={
                  ...
                  <label for="field-1" className="col-sm-3 control-label">
                    Reg ID
                  </label>
