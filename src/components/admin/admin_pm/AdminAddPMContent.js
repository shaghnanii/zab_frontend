...
export const AdminAddPMContent = () => {
  ...
  const success_msg = () => {
    var opts = {
      ...
      "hideMethod": "fadeOut",
      "onHidden": function () {
        window.location = "/admin/pm-list";
      }
    }
    toastr.success('Successfully added new pm.', 'Success Message', opts);
  }
  const failure_msg = () => {
    var opts = {
      "closeButton": true,
    ...
    toastr.error('Failed to added new pm.', 'Failure Message', opts);
  }
