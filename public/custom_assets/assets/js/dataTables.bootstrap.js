		...
		"fnInit": function( oSettings, nPaging, fnDraw ) {
			...
			jQuery(nPaging).append(
				'<ul class="pagination pagination-sm">'+
					'<li class="prev disabled"><a href="javascript:void(0);"><i class="entypo-left-open"></i></a></li>'+
					'<li class="next disabled"><a href="javascript:void(0);"><i class="entypo-right-open"></i></a></li>'+
				'</ul>'
			);
		...
		"fnUpdate": function ( oSettings, fnDraw ) {
			...
			for ( i=0, ien=an.length ; i<ien ; i++ ) {
				...
				for ( j=iStart ; j<=iEnd ; j++ ) {
					...
					jQuery('<li '+sClass+'><a href="javascript:void(0);">'+j+'</a></li>')
