           ...
           var $this  = this,
            ...
            if (data.results && data.results.length > 0) {
                ...
                $(data.results).each(function(i) {
                    ...
                    var item = $('<li><a href="javascript:void(0);">' + this.title + '</a></li>').data('choice', this);
                ...
                if (this.options.msgMoreResults) {
                    ...
                    $('<li>').addClass($this.options.moreResultsClass).html('<a href="javascript:void(0);">' + $this.options.msgMoreResults + '</a>').appendTo($this.search.dropdown).on(events);
                }
